select case when s1.group_name is null then 'No group' else s1.group_name end as group_name ,users.id user_id,users.name,s1.check_in_created_at,s1.check_in_address,s1.check_in_latitude,s1.check_in_longitude
